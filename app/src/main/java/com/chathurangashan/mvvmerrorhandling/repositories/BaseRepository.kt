...
open class BaseRepository {
    ...
    /**
     * This function is act as a common function to perform network calls in the repository layer
     *
     * @param networkCallExecution: the function block that call the relevant network call and handel
     * the response
     *
     */
    suspend fun processApiResult(networkCallExecution:suspend () -> Unit){

        try {
            networkCallExecution.invoke()
     ...
     * endpoint successfully but from server throwing error generated by backend logic.
     *
